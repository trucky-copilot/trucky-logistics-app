...
import { FileSearch, Upload, CheckCircle2, AlertTriangle, XCircle, Loader2, FileText, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <div className="p-4 md:p-6 max-w-3xl mx-auto space-y-4">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Analiza rate confirmations y detecta cláusulas abusivas</p>
      </div>

      {/* Input area */}
      <div className="bg-card border border-border rounded-xl p-4 space-y-3">
        <div className="flex items-center justify-between">
          <label className="text-sm font-medium text-foreground">Pega el texto del documento</label>
        ...
        <textarea
          ...
          placeholder={`Pega aquí el texto del rate confirmation, contrato o acuerdo de transporte...
...
Detention: $0/hr after 2 free hours
Late delivery penalty: $250/hour...`}
      ...
      {error && (
        <div className="flex items-center gap-2.5 p-3 rounded-xl bg-red-400/10 border border-red-400/20 text-sm text-red-400">
          ...
          <div className={`rounded-xl border p-4 ${veredicto?.bg}`}>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">Semáforo general: {analysis.semaforo_general?.toUpperCase()}</div>
              </div>
            </div>
